        ...
        <section className="flex flex-col">
            ...
            <div className="ticket_list_container pl-4">
                {tickets.map((ticket) => (
                    ...
                    >
                        <div className="ticket_card_header flex justify-between items-center mb-2 text-theme-body-sm">
                        ...
                        <div className="ticket_status flex items-center gap-2 mt-2">
                            <span className={`status_indicator text-theme-body-sm rounded-full h-2 w-2 shadow-md ${ticket.status === 'active' ? 'bg-green-500 shadow-green-500/50' : ticket.status === 'pending' ? 'bg-yellow-500 shadow-yellow-500/50' : 'bg-gray-500 shadow-gray-500/50'}`}></span>
