    ...
    <section className="py-20 px-6 lg:px-16 xl:px-24 bg-white border-y border-slate-50">
      <div className="max-w-screen-xl mx-auto flex flex-col gap-16">
        ...
        <div className="flex flex-col items-center text-center">
          <span className="text-theme-tiny font-bold tracking-[0.25em] text-purple-600 uppercase mb-2">
            {displayEyebrow}
          </span>
          <h2 className="text-theme-h3 font-serif tracking-tight text-gray-900 mb-10">
            {displayTitle}
          </h2>
          ...
          <div className="relative w-full max-w-2xl min-h-[180px] flex items-center justify-center px-8">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {/* Comment */}
                <blockquote className="text-theme-body sm:text-theme-h6 md:text-theme-h5 font-light italic text-slate-700 leading-relaxed mb-6">
                ...
                <div className="flex items-center gap-3">
                  <div
                    className="w-10 h-10 rounded-full flex items-center justify-center text-white text-theme-caption font-bold shadow-sm"
                    style={{
                  ...
                  <div className="text-left">
                    <cite className="not-italic text-theme-body-sm font-bold text-slate-800 block">
                      {activeTestimonial.name}
                    </cite>
                    {testimonialSub && (
                      <span className="text-theme-xxs text-slate-400">
                        {testimonialSub}
                      </span>
                    )}
                  </div>
          ...
          {currentBadges.map((badge) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <h4 className="text-theme-caption font-bold text-slate-800 leading-tight">
                    {badge.title}
                  </h4>
                  <p className="text-theme-tiny text-slate-400 mt-0.5">
                    {badge.subtitle}
                  </p>
                </div>
              </div>
