...
export function TaxBreakdownPanel({
  ...
  if (!tax) {
    return (
      <div className="flex items-center gap-2 py-2.5 px-3 rounded-xl bg-amber-50/70 border border-amber-100 text-xxs sm:text-theme-caption text-amber-700">
          ...
          >
            <div className="px-3.5 py-3 bg-white space-y-2 border-t border-gray-100">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-theme-caption sm:text-theme-body-sm">
                ...
                <div className="flex justify-between text-theme-caption sm:text-theme-body-sm pt-1.5 border-t border-gray-100">
...
export function TaxLoadingSkeleton() {
  return (
    <div className="flex items-center gap-2 py-2.5 px-3 rounded-xl bg-blue-50/70 border border-blue-100 text-xxs sm:text-theme-caption text-blue-600">
